...
sprintf(Text,"Group ID=%u       Node ID=%u       cabin_temp=%.2f       RSSI =%u       CRCRight=%u \r\n",
...
sprintf(Text,"Group ID=%u       Node ID=%u       fuel_temp=%.2f       RSSI =%u       CRCRight=%u \r\n",
