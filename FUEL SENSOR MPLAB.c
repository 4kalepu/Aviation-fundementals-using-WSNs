...
ADC_CH1 & ADC_INT_OFF & ADC_REF_VDD_VSS,0);
...
SetChannel(CHANNEL_25); //set RF channel CHANNEL_11-CHANNEL_26 (EACH GROUP MUST HAVE UNIQUE CHANNEL)
...
//cabin_temp = ((-18.61)*Voltage1) + 42.5;
   

Voltage2= (float)ADCresult2*3.3/1023;
fuel_temp = ((-92.8)*Voltage2) + 37.4;
//Light=a*Voltage2+b;
...
//TxPacket.Data1 = cabin_temp;

TxPacket.Data1 = fuel_temp;
...
sprintf(Text,"Group ID=%u       Node ID=%u       fuel_temp=%.2f       RSSI_2 =%u       CRCRight=%u \r\n",

TxPacket.GID, TxPacket.NID, TxPacket.Data1, Strength, CRCRight);
...
sprintf(Text,"Group ID=%u       Node ID=%u       cabin_temp=%.2f       RSSI_4 =%u       CRCRight=%u \r\n",
